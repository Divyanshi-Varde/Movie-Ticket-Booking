...
export const theaterData: TheaterData[] = [
  ...
  },
  {
    ...
    city: "surat",
    address:
      "Surat-Dumas Road, Pipload, Opposite Iris Mall, Surat, Gujarat 395007",
    badge: "XXI",
    dimension: [
      {
        dimensionCategory: "2D",
  ...
  },
  {
    ...
    city: "mumbai",
    address:
      "Unit No - 04, Senapati Bapat Marg, Lower Parel, Mumbai, Maharashtra 400013",
    badge: "CGV",
    dimension: [
      {
        dimensionCategory: "Regular 2D",
  ...
  },
  {
    ...
    city: "mumbai",
    address:
      "2nd Nakshatra Cine Shoppe, Ranade Rd, near Railway Station, Dadar West, Dadar, Mumbai, Maharashtra 400028",
    badge: "CINEPOLIS",
    dimension: [
      {
        dimensionCategory: "2D",
  ...
  },
  {
    ...
    city: "ahmedabad",
    address:
      "3rd floor, Infinity Mall, New Link Rd, Phase D, Shastri Nagar, Versova, Mumbai, Maharashtra 400036",
    badge: "CGV",
    dimension: [
      {
        dimensionCategory: "Regular 2D",
  ...
  },
  {
    ...
    city: "ahmedabad",
    address:
      "3rd floor, Himalaya Mall Commercial Building Big Bazar, Drive In Rd, Nilmani Society, Memnagar, Ahmedabad, Gujarat 380054",
    badge: "CINEPOLIS",
    dimension: [
      {
        dimensionCategory: "2D",
  ...
  },
  {
    ...
    city: "ahmedabad",
    address:
      "Devarc Mall, FP 181/1,3rd floor, Sarkhej - Gandhinagar Hwy, opposite Bigbazar, Ramdev Nagar, Ahmedabad, Gujarat 380015",
    badge: "XXI",
    dimension: [
      {
        dimensionCategory: "2D",
